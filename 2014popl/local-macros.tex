...
\newtheorem{axiom}{Axiom}{\bfseries}{\rmfamily}
\newtheorem{lemma}{Lemma}{\bfseries}{\rmfamily}
\newtheorem{theorem}{Theorem}{\bfseries}{\rmfamily}
\newtheorem{corollary}{Corollary}{\bfseries}{\rmfamily}
...
\newcommand{\lzfclang}{\ensuremath{\lambda_{\mathrm{ZFC}}}\xspace}
...
\newenvironment{tlzfcenv}[1][l]%
{%
	\begin{varwidth}[t]{\textwidth}%
	\mathversion{sans}$\mspace{1mu}%
}%
{%
	\mspace{1mu}$\mathversion{normal}%
	\end{varwidth}%
}
...
\newcommand{\ilzfc}[2][l]{\begin{ilzfcenv}[#1]#2\end{ilzfcenv}}
\newcommand{\tlzfc}[2][l]{\begin{tlzfcenv}[#1]#2\end{tlzfcenv}}

\newcommand{\lzfcsplit}[2][@{\ }]{\lzfc[r #1 l]{#2}}

\newcommand{\ilzfclet}[2]{\ilzfc{let\ \ \ilzfc[r@{\ \objdef\ }l]{#1} \\ \ilzfc{\tab in\ \ #2}}}
\newcommand{\ilzfccond}[2][\ \Longrightarrow\ ]{\ilzfc{cond\ \ \ilzfc[l@{\ {#1}\ }l]{#2}}}
\newcommand{\ilzfccase}[3][\ \Longrightarrow\ ]{\ilzfc{case\ \ {#2}\\\ \ \ilzfc[l@{\ {#1}\ }l]{#3}}}
