...
(define (m3* m1 m2)
  ...
  (define m (m3transpose m2))
  (vector (m3apply m v1) (m3apply m v2) (m3apply m v3)))
...
(define (m3make-scale x-scale y-scale z-scale)
