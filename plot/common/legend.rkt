...
(define (line-legend-entries label zs colors widths styles)
  ...
  (define hash
    (for/fold ([hash  empty]) ([z      (in-list zs)]
                               [color  (in-cycle (apply-colors colors zs))]
                               [width  (in-cycle (apply-line-widths widths zs))]
                               [style  (in-cycle (apply-line-styles styles zs))])
...
(define (rectangle-legend-entries label zs fill-colors fill-styles line-colors line-widths line-styles)
  ...
  (define hash
    (for/fold ([hash  empty]) ([z           (in-list zs)]
                               [fill-color  (in-cycle (apply-colors fill-colors zs))]
                               [fill-style  (in-cycle (apply-fill-styles fill-styles zs))]
                               [line-color  (in-cycle (apply-colors line-colors zs))]
                               [line-width  (in-cycle (apply-line-widths line-widths zs))]
                               [line-style  (in-cycle (apply-line-styles line-styles zs))])
      (define entry-label (real->string/trunc z digits))
...
(define (interval-legend-entries label zs fill-colors fill-styles line-colors line-widths line-styles
  ...
  (define hash
    (for/fold ([hash  empty]) ([za           (in-list zs)]
                               ...
                               [line-width   (in-cycle (apply-line-widths line-widths zs))]
                               [line-style   (in-cycle (apply-line-styles line-styles zs))]
                               [line1-color  (in-cycle (apply-colors line1-colors zs))]
                               [line1-width  (in-cycle (apply-line-widths line1-widths zs))]
                               [line1-style  (in-cycle (apply-line-styles line1-styles zs))]
                               [line2-color  (in-cycle (apply-colors line2-colors zs))]
                               [line2-width  (in-cycle (apply-line-widths line2-widths zs))]
                               [line2-style  (in-cycle (apply-line-styles line2-styles zs))])
      (define entry-label
...
(define (contour-intervals-legend-entries label z-min z-max zs
  ...
  (define ccs (append (list 0)
                      (sequence-take (in-cycle (apply-colors contour-colors zs)) 0 (length zs))
                      (list 0)))
  (define cws (append (list 0)
                      (sequence-take (in-cycle (apply-line-widths contour-widths zs)) 0 (length zs))
                      (list 0)))
  (define css (append '(transparent)
                      (sequence-take (in-cycle (apply-line-styles contour-styles zs)) 0 (length zs))
                      '(transparent)))
